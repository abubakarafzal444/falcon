...
import PipelineKanbanHeader from 'components/app/pipeline/PipelineKanbanHeader';
import DetailedCardViewMainPage from 'components/app/pipeline/DetailedCardView/DetailedCardView_MainPage';
import List from 'components/app/pipeline/List';
...
const MainRoutes = () => (
  <Switch>
    ...
    <Route path="/app/pipeline" exact component={PipelineKanbanHeader} />
...
{/* Routes added by abubakar */}
    <Route path="/app/DetailedView/:cardId" component={DetailedCardViewMainPage}/>
    <Route path="/app/deals" exact >
